...
class CIFAR10_Module(pl.LightningModule):
    ...
    def val_dataloader(self):
        ...
        dataloader = DataLoader(dataset, batch_size=self.hparams.batch_size, num_workers=4, shuffle=False, pin_memory=True)
        return dataloader
...
class CIFAR10_Module_represention(CIFAR10_Module):
    ...
    def forward(self, batch):
        images, labels = batch
        predictions, representations = self.model(images)
        predictions_approx, representations_approx = self.model_approx(images)
